...
module.exports.save = function(obj, cb){
    database(function(err, con){
        var db = con.db("tss6");
        db.collection("file").insertOne(obj, cb);
    });
}
...
module.exports.delete=function(where, cb){
    database(function(err, con){
        var db = con.db("tss6");
        db.collection("file").remove(where, cb);
...
module.exports.update = function(where, obj, cb){
    database(function(err, con){
        var db = con.db("tss6");
        db.collection("file").update(where, { $set : obj }, cb);
    });
}
module.exports.find = function(where, cb){
    database(function(err, con){
        var db = con.db("tss6");
        db.collection("file").find(where).toArray(cb);
    });
}
